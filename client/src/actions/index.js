...
export const GetPokemons = () => async (dispatch) => {
  try {
    const res = await axios.get("https://pokemon-deploy-production-14af.up.railway.app/pokemons");
...
export const GetPokemonDetail = (id) => async (dispatch) => {
  try {
    const payload = await axios
      .get(`https://pokemon-deploy-production-14af.up.railway.app/pokemons/${id}`)
      .then((res) => res.data);
...
export const GetPokemon = (name) => async (dispatch) => {
  try {
    const payload = await axios
      .get(`https://pokemon-deploy-production-14af.up.railway.app/pokemons?name=${name}`)
      .then((res) => res.data);
...
export const GetType = () => async (dispatch) => {
  try {
    const payload = await axios
      .get("https://pokemon-deploy-production-14af.up.railway.app/types")
      .then((res) => res.data);
